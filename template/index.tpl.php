...
<head>
    ...
    <!-- VEGAS STYLE CSS -->
    <link href="../plugins/jquery.vegas.min.css" rel="stylesheet" />
    <!-- CUSTOM STYLE CSS -->
...
<body>
    ...
    <div class="container" id="home">
        <div class="row text-center">
            <div class="col-md-12">
                <h1 class="head-main">JHON DONGA</h1>
                <h2 class="head-sub-main">Lorem ipsum dolor</h2>
                <a class="btn btn-danger btn-lg " href="#about">Read More </a><a class="btn btn-default btn-lg" href="#contact-sec">Leave Here </a>
